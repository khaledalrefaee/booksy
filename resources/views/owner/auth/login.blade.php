                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 ps-md-0">
                                <div class="auth-form-wrapper px-4 py-5">
                                    ...
                                    <form method="POST" action="{{ route('owner.login.attempt') }}" class="forms-sample">
                                        @csrf
                                    ...
                                    <div class="mt-4 d-flex gap-2">
                                        ...
                                        <a href="{{ route('locale.switch', ['locale' => 'en']) }}"
                                           class="text-muted small {{ $currentLocale === 'en' ? 'fw-bold text-primary' : '' }}">
                                            <i class="flag-icon flag-icon-us me-1"></i>English
                                        </a>
                                        <span class="text-muted small">|</span>
                                        <a href="{{ route('locale.switch', ['locale' => 'ar']) }}"
                                           class="text-muted small {{ $currentLocale === 'ar' ? 'fw-bold text-primary' : '' }}">

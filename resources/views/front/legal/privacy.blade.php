@php
    ...
    $toc = [
        ['id' => 'collect', 'label' => $isAr ? 'ما نجمعه'      : 'What we collect'],
        ['id' => 'use',     'label' => $isAr ? 'كيف نستخدمه'   : 'How we use it'],
        ['id' => 'share',   'label' => $isAr ? 'المشاركة'      : 'Sharing'],
        ['id' => 'cookies', 'label' => $isAr ? 'ملفات التعريف' : 'Cookies'],
        ['id' => 'rights',  'label' => $isAr ? 'حقوقك'         : 'Your rights'],

...
<head>
    ...
    <title>403 — {{ $isAr ? 'غير مصرح' : 'Access denied' }}</title>
    <style>
...
<body>
    <div class="wrap">
        ...
        <p>
            {{ $isAr
                ? 'هذه الصفحة محمية ولا تملك الصلاحية اللازمة لعرضها.'
                : "This page is restricted and you don't have permission to view it." }}
        </p>
        <div class="actions">

...
<div class="page-content">
    ...
    <div class="mb-4">
        <h4 class="mb-2">{{ __('Add service') }}</h4>
        ...
        <div class="col-md-8 col-xl-7">
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-body p-4 p-md-5">
                    ...
                    <form method="POST" action="{{ route('company.branches.services.store', $branch) }}" novalidate>
                        @csrf
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="name_ar" name="name_ar"
                                       ...
                                       value="{{ old('name_ar') }}" dir="rtl" maxlength="255">
                            </div>
                            <div class="col-12">
                                <label for="description" class="form-label fw-semibold">{{ __('Description') }}</label>
                                <textarea id="description" name="description"
                                          class="form-control rounded-3" rows="3">{{ old('description') }}</textarea>
                            </div>
                        </div>
